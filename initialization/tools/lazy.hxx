...
namespace li {
    namespace detail {
        ...
        {
        #if defined(_M_X64) or defined(__amd64__)
        #if defined(_MSC_VER)
        ...
        struct lazy_function : lazy_base<lazy_function<OHP, T>, T> {
            ...
            LAZY_IMPORTER_FORCEINLINE static F get() noexcept
            {
                ...
                do {
                    ...
                    if (!e.value->DllBase or !e.value->FullDllName.Length)
                        continue;
                #endif
            ...
            LAZY_IMPORTER_FORCEINLINE static F forwarded() noexcept
            {
                ...
                do {
                    ...
                    if (!hashes.module_hash or hash(name, get_offset(OHP)) == hashes.module_hash) {
                        const exports_directory exports(e.value->DllBase);
